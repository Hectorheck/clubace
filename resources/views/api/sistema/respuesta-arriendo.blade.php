			...
			<div class="container">
				<div class="row">
					...
					<div class="col-12">
						...
						<h2 class="text-lg">Transacción aprobada</h2>
						@else
						<h2 class="text-lg">Transacción rechazada</h2>
						@endif
						<table class="table">
							<thead>
								<tr>
									<th scope="col">Código Transacción:</th>
									<td>{{ ($agenda instanceof \Illuminate\Database\Eloquent\Collection) ? implode('-', $ordenCompra) : $agenda['id'] }}</td>
								</tr>
							</thead>
							<tbody>
								<tr>
