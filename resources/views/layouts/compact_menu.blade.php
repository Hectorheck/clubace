...
z-index: 999999">
	...
	<div id="wrap">
			...
			<nav class="navbar navbar-static-top">
				<div class="container-fluid m-0">
					<a class="navbar-brand" href="{{ route('/') }}">
						<h4>
							<img src="{{ asset('recursos/img/logoaceclub.png') }}" class="admin_img" alt="logo">
							<span class="ml-2">AceClub</span>
						</h4>
					</a>
							...
							<div class="user-settings no-bg">
								...
								<div class="dropdown-menu admire_admin">
									<a class="dropdown-item title" href="#">
										Administrador Aceclub</a>
									<a class="dropdown-item" href="{{ route('perfil') }}"><i class="fa fa-cogs"></i> Perfil</a>
									<!--<a class="dropdown-item" href="{{ route('cambio.menu') }}"><i class="fa fa-cogs"></i>Ir menu socios</a>-->
									<a class="dropdown-item" data-toggle="modal" data-target="#cambioPass" href="#"><i class="fa fa-key" aria-hidden="true"></i></i> Cambiar contraseña</a>
									<form method="post" action="{{ route('logout') }}">
										@csrf
										<button class="dropdown-item" type="submit"><i class="fa fa-sign-out"></i> Salir</button>
									</form>
							...
							<div class="user-wrapper">
								<a class="user-link" href="#">
									<img class="media-object img-thumbnail user-img rounded-circle admin_img3"
										alt="User Picture" src="{{ auth()->user()->profile_photo_url }}">
									<p class="user-info menu_hide">Bienvenido {{ auth()->user()->nombres }}</p>
								</a>
							</div>
						</div>
						<hr />
					...
					<ul id="menu">
						<li {!! (Request::is('/')? 'class="active"' :"") !!}>
							<a href="{{ URL::to('/') }} ">
								...
								<span class="link-title menu_hide">&nbsp;&nbsp;Agenda</span>
							</a>
						</li>
						...
						<li
							...
							<ul>
								...
								<li {!! (Request::is('users/eliminados')? 'class="active"' :"") !!}>
									<a href="{{ route('users.eliminados') }} ">
										<i class="fa fa-angle-right"></i>
										&nbsp; Usuarios eliminados
									</a>
								</li>
						...
						{{-- <li {!! (Request::is('calendar')? 'class="active"' :"") !!}>
							<a href="{{ URL::to('calendar') }} ">
								...
								<span
									class="badge badge-pill badge-warning float-right calendar_badge menu_hide">7</span>
							</a>
						</li>
						...
						<li
							class="dropdown_menu {!! (Request::is('maps')|| Request::is('jqvmaps') ? 'active' : '') !!}">
							<a href="#">
		...
		<div class="modal fade" id="cambioPass" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
			 aria-hidden="true">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					<form class="form" method="post" action="{{ route('perfil.update.pass') }}">
						@csrf
						...
						<div class="modal-body">
							<div class="form-group mx-sm-3 mb-2">
								<input type="password" name="old_password" placeholder="Contraseña actual" class="form-control">
							</div>
							<div class="form-group mx-sm-3 mb-2">
								<input type="password" name="password" placeholder="Contraseña nueva" class="form-control">
							</div>
							<div class="form-group mx-sm-3 mb-2">
