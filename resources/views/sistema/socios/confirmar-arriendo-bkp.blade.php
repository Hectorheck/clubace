		...
		<div class="container">
			<form action={{  $response_transbank->getUrl() }}>
				...
				<div class="row">
					...
					<div class="col-6">
						<h3 class="font-bold">Request Transbank:</h3>
						<pre>{{ print_r($request_trasnbank , true)  }}</pre>
					</div>

					<div class="col-6">
						<h3 class="font-bold">Respuesta Transbank:</h3>
						<pre>{{ print_r($response_transbank , true)  }}</pre>
					</div>

					<div class="col-12">
						<h3 class="font-bold">Agenda:</h3>
						<pre>{{ print_r($agenda->toArray() , true) }}</pre>
					</div>
