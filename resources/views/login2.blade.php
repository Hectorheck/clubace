...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="{{asset('css/pages/login2.css')}}"/>
</head>
                ...
                <div class="col-lg-4  col-md-8 col-sm-12  mx-auto login_image login_section login_section_top">
                    <div class="login_logo login_border_radius1">
                        <h3 class="text-center text-white">
                            <img src="{{--asset('img/logow2.png')--}}{{asset('img/logoaceclub.png')}}" alt="josh logo" class="admire_logo">
                        </h3>
                    </div>
                    ...
                    <div class="m-t-15">
                        <form action="{{url('index')}}" id="login_validator" method="get">
                            {{ csrf_field()}}
                            ...
                            <div class="m-t-15 text-center">
                                <a href="forgot_password2" class="text-white">Forgot password ?</a>
                            </div>
                        </form>
                    </div>
                </div>
...
<!--End of plugin js-->
<script type="text/javascript" src="{{asset('js/pages/login2.js')}}"></script>
