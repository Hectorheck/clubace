			...
			<div class="row no-gutters">
				...
				<div class="col-sm-7 col-lg-6">
					<ol class="breadcrumb float-right nav_breadcrumb_top_align">
						...
						<li class="active breadcrumb-item">Servicios eliminados</li>
					</ol>
				</div>
			</div>
		</div>
	...
	<div class="outer">
		<div class="inner bg-container">
			<div class="row">
				<div class="col-12">
					<div class="card">
						<div class="card-header bg-white">Lista de servicios eliminados</div>
							...
							<div class="table-responsive">
								<table class="table  table-striped table-bordered table-hover dataTable no-footer" id="editable_table" role="grid">
									...
									<tbody>
										...
										{{-- @dd($servicio->clubes()->withTrashed()->first()->display_name) --}}
										<tr>
											<td>{{ $servicio->nombre }}</td>
											<td>{{ ($servicio->clubes()->withTrashed()->first()) ? $servicio->clubes()->withTrashed()->first()->display_name : 'ELIMINADO' }}</td>
											<td>
												<div class="btn-group">
													<a href="{{ route('servicios.restaurar', $servicio->id) }}" class="btn btn-primary"><i class="fa fa-rotate-left"></i> Restaurar</a>
													<a href="{{-- route('servicios.borrar', $servicio->id) --}}" data-toggle="modal" data-target="#del-{{ $servicio->id }}" class="btn btn-danger">Eliminar</a>
												</div>
											</td>
										</tr>
										@endforeach
		...
		<div class="modal-content">
			<div class="modal-header">
				<div class="container d-flex pl-0"><i class="fa fa-trash {{-- fa-2x --}}"></i>
					<h5 class="modal-title ml-2" id="exampleModalLabel">¿Seguro que desea borrar el Servicio {{ $servicio->nombre }} de manera PERMANENTE?</h5>
			...
			<div class="modal-footer">
				...
				<a href="{{ route('servicios.borrar', $servicio->id) }}" class="btn btn-danger">Borrar</a>
			</div>
		</div>
	</div>
</div>
