					...
					<div class="row">
						...
						<div class="col-12 col-md-6">
							<div class="form-group"> <!-- AGREGAR LA CLASE ERROR PARA MARCAR EL ERROR -->
								...
								<input type="email" name="email" class="form-control" id="" placeholder="" value="{{ old('email') }}">
						...
						<div class="col-12 col-md-6">
							<div class="form-group "> <!-- AGREGAR LA CLASE ERROR PARA MARCAR EL ERROR -->
								...
								<input type="text" name="nombres" class="form-control" id="" placeholder="" value="{{ old('nombres') }}">
								<small class="mensaje-error">Error al ingresar este campo</small>
							</div>
						</div>
						<div class="col-12 col-md-6">
						...
						<div class="col-12">
							<div class="row">
								<div class="col">
									<button type="submit" class="btn btn-success mb-25 mt-25">Registrar</button>
								</div>
							</div>
						</div>
						<div class="col-12 text-center">
							<p class="fz14">¿Tienes una cuenta? <a href="{{ route('login') }}">Ingresa aquí</a></p>
						</div>
					</div>
				 </form>
			</div>
